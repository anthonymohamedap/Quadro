...
| US-50 | Drag-drop planning → nieuwe DataTransfer-API (CS0618 wegwerken) | Laag | ✅ gemerged (DnD op `DataTransfer`/`DoDragDropAsync`: `DataFormat.CreateStringApplicationFormat` + `DataTransferItem.Create`/`TryGetValue`, `#pragma CS0618` weg, 0 warnings) |
